...
// --- CONFIGURACIÓN DE LA API (HARDCODED PARA DEMO) ---
// ⚠️ IMPORTANTE: Regenerar esta clave después de la exposición por seguridad.
...
export const TranslatorPage: React.FC = () => {
  ...
  const handleTranslate = async () => {
    ...
    try {
      ...
      // Usamos 'gemini-pro' que es el modelo estándar y estable
      ...
      if (err.message.includes("API key")) {
        errorMsg = "La API Key no es válida. Verifica la clave pegada en el código.";
      } else if (err.message.includes("404")) {
        errorMsg = "Modelo no encontrado. Asegúrate de usar 'gemini-pro'.";
